...
class Equipe
{
  ...
  public function enregistrer()
  {
    $requete = $this->db->prepare(
      'INSERT INTO Equipe(nom, logo, annee_de_creation)
      VALUES(:nom, :logo, :annee_de_creation)');
    $requete->bindValue(':nom', $this->getNom());
    $requete->bindValue(':logo', $this->getLogo());
    $requete->bindValue(':annee_de_creation', $this->getAnneeDeCreation());
    $requete->execute();
